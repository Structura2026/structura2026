...
type: "navigation",
  ...
  {
  type: "buy_advertising",
  mode: "single",
  uid: "buy_advertising",
  label: "Buy_advertising",
  children: [
  ...
  label: "Survey",
  children: [
    { type: "previous_surveys", mode: "single", uid: "previous_surveys", label: "Previous_surveys" },
  ],
},

 {
  ...
  label: "Contest",
  children: [
    { type: "previous_contests", mode: "single", uid: "previous_contests", label: "Previous_contests" },
  ],
},

 {
  type: "guest_blogposts",
  mode: "single",
  uid: "guest_blogposts",
  label: "Guest_blogposts",
  children: [
    {
      type: "guest_blogposts_individual",
      mode: "single",
      uid: "guest_blogposts_individual",
      label: "Individual_guest_blog_posts",
    },
    {
      type: "rules_guidelines_guestblogposts",
      mode: "single",
      uid: "rules_guidelines_guestblogposts",
      label: "Rules_guidelines_guest",
    },
    {
      type: "price_for_guestblogposts",
      mode: "single",
      uid: "price_for_guestblogposts",
      label: "Price_for_guestblogposts",
    },
  ],
},

 {
  type: "sponsored_blogpost",
  mode: "single",
  uid: "sponsored_blogpost",
  label: "Sponsored_blogpost",
  children: [
    {
      type: "sponsored_blogpost_individual",
      mode: "single",
      uid: "sponsored_blogpost_individual",
      label: "Individual_sponsored_blog_posts",
    },
    {
      type: "rules_guidelines_sponsored_blogposts",
      mode: "single",
      uid: "rules_guidelines_sponsored_blogposts",
      label: "Rules_guidelines_sponsored_blogposts",
    },
    {
      type: "price_for_sponsored_blogposts",
      mode: "single",
      uid: "price_for_sponsored_blogposts",
      label: "Price_for_sponsored_blogposts",
    },
  ],
},
...
{ type: "affiliate_marketing", mode: "single", uid: "affiliate_marketing", label: "Affiliate_marketing" },
  ...
  mode: "single",
  uid: "dictionary_formulas_models",
  label: "Dictionary_formulas_models",
  children: [
  ...
  children: [
    {
      type: "rules_guidelines_bots_ai",
      mode: "single",
      uid: "rules_guidelines_bots_ai",
      label: "Rules_guidelines_bots_AI",
    },
    {
      type: "allowed_blocked_bots_ai",
      mode: "single",
      uid: "allowed_blocked_bots_ai",
      label: "Allowed_blocked_bots_AI",
    },
    {
      type: "price_for_bots_ai",
      mode: "single",
      uid: "price_for_bots_ai",
      label: "Price_for_bots_AI",
    },
    {
    ...
    {
      type: "machine_readable_files",
      mode: "single",
      uid: "machine_readable_files",
